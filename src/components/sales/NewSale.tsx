    ...
    <div className="h-screen max-h-screen p-6 flex flex-col bg-white text-base overflow-hidden">
      ...
      <div className="flex-1 min-h-0 flex gap-6 overflow-hidden">
        <div className="flex-1 flex flex-col min-h-0 overflow-y-auto custom-scrollbar pr-2">
              ...
              <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400">
                    {selectedClient.tipo === "PJ" ? selectedClient.cnpj : selectedClient.cpf}
                  </p>
                </div>
                <button
                  type="button"
          ...
          <form onSubmit={handleAddCartItem} className="flex gap-3 mb-5 items-end">
            ...
            <button
              type="submit"
              className={`shrink-0 flex ${INPUT_FIELD_HEIGHT_CLASS} w-14 items-center justify-center rounded-lg bg-[#FF5A1F] text-white hover:bg-[#E64D17] transition-colors cursor-pointer shadow-none`}
